...
//Normally defined in astra/capi/streams/image_cpi.h
//but can't include that in C program in v0.5.
//Declare it here and it will be available when linking to astra.dll/libastra.dylib/libastra.so
