...
SENSEKIT_API sensekit_status_t sensekit_stream_get_description(sensekit_streamconnection_t* connection, sensekit_stream_desc_t* description) 
{
...
SENSEKIT_API sensekit_status_t sensekit_reader_open_frame(sensekit_reader_t* reader, int timeoutMillis, sensekit_reader_frame_t** frame) 
{
...
SENSEKIT_API sensekit_status_t sensekit_reader_get_frame(sensekit_reader_frame_t* frame, sensekit_stream_type_t type, sensekit_stream_subtype_t subType, sensekit_frame_ref_t** frameRef) 
{
    return g_Context.reader_get_frame(frame, type, subType, *frameRef);
}

SENSEKIT_API sensekit_status_t sensekit_stream_set_parameter(sensekit_streamconnection_t* connection, sensekit_parameter_id parameterId, size_t byteLength, sensekit_parameter_data_t* data) 
{
    return g_Context.stream_set_parameter(connection, parameterId, byteLength, data);
}

SENSEKIT_API sensekit_status_t sensekit_stream_get_parameter_size(sensekit_streamconnection_t* connection, sensekit_parameter_id parameterId, size_t* byteLength) 
{
    return g_Context.stream_get_parameter_size(connection, parameterId, *byteLength);
}

SENSEKIT_API sensekit_status_t sensekit_stream_get_parameter_data(sensekit_streamconnection_t* connection, sensekit_parameter_id parameterId, size_t byteLength, sensekit_parameter_data_t* data) 
{
