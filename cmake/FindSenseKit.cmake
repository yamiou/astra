...
# - SENSEKIT_LIBRARIES:    the list of all core SenseKit libraries
...
# - SENSEKIT_LIB_DIR:      the path where SenseKit libs are located
# - SENSEKIT_PLUGIN_LIBRARIES: the list of all plugin libraries
# - SENSEKIT_TOML:         a list TOML configuration files for SenseKit
# - SENSEKIT_PLUGIN_TOML:  a list of TOML configuration files for plugins
#
# example:
#   find_package(SenseKit REQUIRED)
...
if (NOT SENSEKIT_SDK_BUILD)
  ...
  MARK_AS_ADVANCED(SENSEKIT_LIB_DIR)
  ...
  foreach(FIND_SENSEKIT_COMPONENT ${SENSEKIT_FIND_COMPONENTS})
    ...
    if (SENSEKIT_${FIND_SENSEKIT_COMPONENT_UPPER}_LIBRARY_DEBUG OR SENSEKIT_${FIND_SENSEKIT_COMPONENT_UPPER}_LIBRARY_RELEASE)
      ...
      if (NOT SENSEKIT_LIB_DIR)
          get_filename_component(SENSEKIT_LIB_DIR ${SENSEKIT_${FIND_SENSEKIT_COMPONENT_UPPER}_LIBRARY_RELEASE} DIRECTORY)
      endif()
    else()
      # library not found
  ...
  if (SENSEKIT_FOUND)
    FILE(GLOB SENSEKIT_PLUGIN_LIBRARIES   "${SENSEKIT_LIB_DIR}/Plugins/*.dll"
                                          "${SENSEKIT_LIB_DIR}/Plugins/*.dylib"
                                          "${SENSEKIT_LIB_DIR}/Plugins/*.so")
    FILE(GLOB SENSEKIT_PLUGIN_TOML   "${SENSEKIT_LIB_DIR}/Plugins/*.toml")
    FILE(GLOB SENSEKIT_TOML   "${SENSEKIT_LIB_DIR}/*.toml")
...
# handle success
if(SENSEKIT_FOUND)
  message(STATUS "Found SenseKit includes in ${SENSEKIT_INCLUDE_DIR}")
  message(STATUS "Found SenseKit lib dir: ${SENSEKIT_LIB_DIR}")
  message(STATUS "Found SenseKit libraries: ${SENSEKIT_LIBRARIES}")
  message(STATUS "Found SenseKit TOML: ${SENSEKIT_TOML}")
  message(STATUS "Found SenseKit plugins: ${SENSEKIT_PLUGIN_LIBRARIES}")
  message(STATUS "Found SenseKit plugin TOML: ${SENSEKIT_PLUGIN_TOML}")
endif()
