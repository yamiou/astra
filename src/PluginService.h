...
namespace sensekit
{
    ...
    public:
        ...
        sensekit_status_t create_stream_bin(stream_handle handle, unsigned int byte_length, /*out*/ StreamBinId& id, /*out*/sensekit_frame_t*& binBuffer);
        sensekit_status_t destroy_stream_bin(stream_handle handle, StreamBinId& id, sensekit_frame_t*& old_buf);
        ...
        sensekit_status_t cycle_bin_buffers(stream_handle handle, StreamBinId id, /*out*/sensekit_frame_t*& new_buf);
