...
namespace sensekit
{
    void PluginServiceImpl::notify_host_event(sensekit_event_id id, const void* data, size_t dataSize)
    {
        m_hostEventSignal.raise(id, data, dataSize);
    }

    sensekit_status_t PluginServiceImpl::create_stream_set(const char* streamUri, sensekit_streamset_t& streamSet)
    {
    ...
    sensekit_status_t PluginServiceImpl::destroy_stream_set(sensekit_streamset_t& streamSet)
    {
    ...
    sensekit_status_t PluginServiceImpl::register_stream_registered_callback(stream_registered_callback_t callback,
                                                                    void* clientTag,
    ...
    sensekit_status_t PluginServiceImpl::register_stream_unregistering_callback(stream_unregistering_callback_t callback,
                                                                       void* clientTag,
                                                                       CallbackId& callbackId)
    {
    ...
    sensekit_status_t PluginServiceImpl::unregister_stream_registered_callback(CallbackId callbackId)
    {
    ...
    sensekit_status_t PluginServiceImpl::unregister_stream_unregistering_callback(CallbackId callbackId)
    {
    ...
    sensekit_status_t PluginServiceImpl::create_stream(sensekit_streamset_t setHandle,
    ...
    sensekit_status_t PluginServiceImpl::destroy_stream(sensekit_stream_t& streamHandle)
    {
    ...
    sensekit_status_t PluginServiceImpl::get_streamset_uri(sensekit_streamset_t setHandle,
                                                       const char*& uri)
    {
    ...
    sensekit_status_t PluginServiceImpl::create_stream_bin(sensekit_stream_t streamHandle,
    ...
    sensekit_status_t PluginServiceImpl::destroy_stream_bin(sensekit_stream_t streamHandle,
                                                        sensekit_bin_t& binHandle,
                                                        sensekit_frame_t*& binBuffer)
    {
        Stream* actualStream = Stream::get_ptr(streamHandle);
    ...
    sensekit_status_t PluginServiceImpl::bin_has_connections(sensekit_bin_t binHandle, bool& hasConnections)
    {
        StreamBin* bin = StreamBin::get_ptr(binHandle);
    ...
    sensekit_status_t PluginServiceImpl::cycle_bin_buffers(sensekit_bin_t binHandle,
                                                       sensekit_frame_t*& binBuffer)
    {
    ...
    sensekit_status_t PluginServiceImpl::link_connection_to_bin(sensekit_streamconnection_t connection,
                                                            sensekit_bin_t binHandle)
    {
    ...
    sensekit_status_t PluginServiceImpl::get_parameter_bin(size_t byteSize,
    ...
    sensekit_status_t PluginServiceImpl::log(const char* channel,
    ...
    sensekit_status_t PluginServiceImpl::register_host_event_callback(host_event_callback_t callback,
                                                                  void* clientTag,
                                                                  CallbackId& callbackId)
    {
    ...
    sensekit_status_t PluginServiceImpl::unregister_host_event_callback(CallbackId callbackId)
    {
