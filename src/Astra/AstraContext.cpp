...
namespace astra {
    ...
    astra_status_t AstraContext::streamset_open(const char* connectionString,
                                                astra_streamsetconnection_t& streamSet)
    {
        return m_impl->streamset_open(connectionString, streamSet);
    }

    astra_status_t AstraContext::streamset_close(astra_streamsetconnection_t& streamSet)
    {
        return m_impl->streamset_close(streamSet);
    }

    astra_status_t AstraContext::reader_create(astra_streamsetconnection_t streamSet,
                                               astra_reader_t& reader)
    {
        return m_impl->reader_create(streamSet, reader);
    }

    astra_status_t AstraContext::reader_destroy(astra_reader_t& reader)
    {
        return m_impl->reader_destroy(reader);
    }

    astra_status_t AstraContext::reader_get_stream(astra_reader_t reader,
    ...
    astra_status_t AstraContext::stream_get_description(astra_streamconnection_t connection,
                                                        astra_stream_desc_t* description)
    {
        return m_impl->stream_get_description(connection, description);
    }

    astra_status_t AstraContext::stream_start(astra_streamconnection_t connection)
    {
        return m_impl->stream_start(connection);
    }

    astra_status_t AstraContext::stream_stop(astra_streamconnection_t connection)
    {
        return m_impl->stream_stop(connection);
    }

    astra_status_t AstraContext::reader_open_frame(astra_reader_t reader,
                                                   int timeoutMillis,
    ...
    astra_status_t AstraContext::reader_close_frame(astra_reader_frame_t& frame)
    {
        return m_impl->reader_close_frame(frame);
    }

    astra_status_t AstraContext::reader_register_frame_ready_callback(astra_reader_t reader,
    ...
    astra_status_t AstraContext::reader_unregister_frame_ready_callback(astra_reader_callback_id_t& callbackId)
    {
        return m_impl->reader_unregister_frame_ready_callback(callbackId);
    }

    astra_status_t AstraContext::reader_get_frame(astra_reader_frame_t frame,
                                                  astra_stream_type_t type,
                                                  astra_stream_subtype_t subtype,
    ...
    astra_status_t AstraContext::stream_set_parameter(astra_streamconnection_t connection,
    ...
    astra_status_t AstraContext::stream_get_parameter(astra_streamconnection_t connection,
                                                      astra_parameter_id parameterId,
    ...
    astra_status_t AstraContext::stream_get_result(astra_streamconnection_t connection,
                                                   astra_result_token_t token,
    ...
    astra_status_t AstraContext::stream_invoke(astra_streamconnection_t connection,
    ...
    astra_status_t AstraContext::temp_update()
    {
