...
namespace sensekit { namespace plugins { namespace hand {
    ...
    inline DepthUtilitySettings parse_depth_utility_settings(cpptoml::table t)
    {
    ...
    inline PointProcessorSettings parse_point_processor_settings(cpptoml::table t)
    {
    ...
    inline TrajectoryAnalyzerSettings parse_trajectory_analyzer_settings(cpptoml::table t)
    {
