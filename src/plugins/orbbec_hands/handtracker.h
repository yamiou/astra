...
private:
	...
	void segmentForeground(cv::Mat& matForeground, cv::Mat& matDepth, cv::Mat& matAreaSqrt, cv::Mat& segmentation, cv::Point& seed, const float referenceDepth, const float bandwidthDepth, const TrackedPointType pointType);
	cv::Point trackPointFromSeed(cv::Mat& matDepth, cv::Mat& matAreaSqrt, cv::Mat& matSegmentation, cv::Mat& matScore, cv::Mat& foregroundSearched, cv::Point& foregroundPosition, const float referenceDepth, const float bandwidthDepth, const TrackedPointType pointType);
	cv::Point convergeTrackPointFromSeed(cv::Mat& matDepth, cv::Mat& matAreaSqrt, cv::Mat& matSegmentation, cv::Mat& matScore, cv::Mat& foregroundSearched, cv::Point& seedPosition, const float referenceDepth, const float bandwidthDepth, const TrackedPointType pointType, const int iterationMax);
	bool isPointInCollection(std::vector<TrackedPoint>& trackedPoints, cv::Point& targetPoint);
	...
	cv::Mat m_matDepthSrc;
	cv::Mat m_matDepthResized;
	...
	void filterZeroValuesAndJumps();
	void thresholdForeground(cv::Mat& matForeground, cv::Mat& matVelocity);
