    ...
    namespace plugins
    {
        namespace hands
        {
            ...
            public:
                ...
                void DebugVisualizer::overlayCrosshairs(vector<TrackedPoint>& points, 
                ...
                void DebugVisualizer::showDepthMat(cv::Mat& matDepth, 
                ...
                void DebugVisualizer::showVelocityMat(cv::Mat& matVelocity, 
                                                      float maxScale, 
                                                      cv::Mat& matForeground, 
                                                      vector<TrackedPoint>& points,
                                                      _sensekit_colorframe& colorFrame)
