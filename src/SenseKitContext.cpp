...
namespace sensekit {
    ...
    sensekit_status_t SenseKitContext::open_sensor(const char *uri, sensekit_sensor_t **sensor)
    {
        //do nothing for now
    ...
    sensekit_status_t SenseKitContext::close_sensor(sensekit_sensor_t **sensor)
    {
        //reverse the nothing we did above
        return SENSEKIT_STATUS_SUCCESS;
    }

    sensekit_status_t SenseKitContext::open_depth_stream(sensekit_sensor_t *sensor, sensekit_depthstream_t **stream)
    {
    ...
    sensekit_status_t SenseKitContext::close_depth_stream(sensekit_depthstream_t **stream)
    {
        //would find the depth plugin and call client removed event, and the plugin might destroy a bin
        return SENSEKIT_STATUS_SUCCESS;
    }

    sensekit_status_t SenseKitContext::open_depth_frame(sensekit_depthstream_t *stream, int timeout, sensekit_depthframe_t*& frame)
    {
    ...
    sensekit_status_t SenseKitContext::close_depth_frame(sensekit_depthframe_t*& frame)
    {
